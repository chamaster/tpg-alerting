      ...
      <header className="bg-red-700 text-white shadow-lg">
        <div className="max-w-2xl mx-auto px-4 py-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-red-200 text-sm">{t.appSubtitle}</p>
          </div>
          <div className="flex items-center gap-3">
            <button
              onClick={toggle}
              className="text-sm bg-red-800 hover:bg-red-900 transition-colors rounded-full px-2.5 py-1 flex items-center gap-1.5"
      ...
      <main className="max-w-2xl mx-auto px-4 py-6 space-y-4">
        ...
        {watchedStops.length === 0 ? (
          <div className="text-center py-16">
            ...
            <h2 className="text-xl font-semibold text-gray-700 mb-2">{t.noStops}</h2>
            <p className="text-gray-500 mb-6">{t.noStopsHint}</p>
            <button
